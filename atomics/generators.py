...
class SinusoidalGenerator(AtomicDEVS):
    ...
    def intTransition(self):
        ...
        return SinusoidalGeneratorState(self.frequency,self.amplitude,self.phase,current_time)
        # return self.state.set(self.frequency,self.amplitude,self.phase,current_time)
